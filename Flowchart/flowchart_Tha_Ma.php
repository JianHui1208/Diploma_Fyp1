...
<div>
	<br>
	<h1>Thailand Company Staff <br>Marketing Department</h1>
	<nav class="nav">
							<ul>
								<li>
									<a href="#">Manager<br><?php echo $Name1022; ?><br><?php echo $email1022; ?></a>
										<ul>
											<li>
												<a href="#">Deputy manager<br><?php echo $Name1023; ?><br><?php echo $email1023; ?></a>
													<ul>
														<li>
															<a href="#">Employee<br><?php echo $Name1025; ?><br><?php echo $email1025; ?></a>
																<li>
																	<a href="#">Employee<br><?php echo $Name1026; ?><br><?php echo $email1026; ?></a>
																</li>
														</li>
													</ul>
														<li>
															<a href="#">Director<br><?php echo $Name1024; ?><br><?php echo $email1024; ?></a>
															<ul>
																<li>
																	<a href="#">Employee<br><?php echo $Name1027; ?><br><?php echo $email1027; ?></a>
																	<li>
																		<a href="#">Employee<br><?php echo $Name1028; ?><br><?php echo $email1028; ?></a>
																	</li>
																</li>
															</ul>
														</li>
