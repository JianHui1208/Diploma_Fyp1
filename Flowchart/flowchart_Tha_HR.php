...
<div class="navbar">
			...
			<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-90deg-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			 ...
			 Back</a>
			<a href="flowchart_Tha_HR.php">Human Resources Department</a>
			<a href="flowchart_Tha_M.php">Maintenance Department</a>
			<a href="flowchart_Tha_Ma.php">Marketing Department</a>
			<a href="flowchart_Tha_IT.php">Information and Technology Department</a>
			 <?php
...
<div>
	<br>
	<h1>Thailand Company Staff<br>Human Resourse Department</h1>
	<nav class="nav">
							<ul>
								<li>
									<a href="#">Manager<br><?php echo $Name1008; ?><br><?php echo $email1008; ?></a>
										<ul>
											<li>
												<a href="#">Deputy manager<br><?php echo $Name1009; ?><br><?php echo $email1009; ?></a>
													<ul>
														<li>
															<a href="#">Employee<br><?php echo $Name1011; ?><br><?php echo $email1011; ?></a>
																<li>
																	<a href="#">Employee<br><?php echo $Name1012; ?><br><?php echo $email1012; ?></a>
																</li>
														</li>
													</ul>
														<li>
															<a href="#">Director<br><?php echo $Name1010; ?><br><?php echo $email1010; ?></a>
															<ul>
																<li>
																	<a href="#">Employee<br><?php echo $Name1013; ?><br><?php echo $email1013; ?></a>
																	<li>
																		<a href="#">Employee<br><?php echo $Name1014; ?><br><?php echo $email1014; ?></a>
																	</li>
																</li>
															</ul>
														</li>
