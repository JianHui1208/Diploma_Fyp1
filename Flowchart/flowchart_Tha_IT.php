...
<div>
	<br>
	<h1>Thailand Company Staff<br>Information and Technology Department</h1>
	<nav class="nav">
							<ul style="text-align: center;">
								<li>
									<a href="#">Manager<br><?php echo $Name1029; ?><br><?php echo $email1029; ?></a>
										<ul>
											<li>
												<a href="#">Deputy manager<br><?php echo $Name1030; ?><br><?php echo $email1030; ?></a>
													<ul>
														<li>
															<a href="#">Employee<br><?php echo $Name1032; ?><br><?php echo $email1032; ?></a>
																<li>
																	<a href="#">Employee<br><?php echo $Name1033; ?><br><?php echo $email1033; ?></a>
																</li>
														</li>
													</ul>
														<li>
															<a href="#">Director<br><?php echo $Name1031; ?><br><?php echo $email1031; ?></a>
															<ul>
																<li>
																	<a href="#">Employee<br><?php echo $Name1034; ?><br><?php echo $email1034; ?></a>
																	<li>
																		<a href="#">Employee<br><?php echo $Name1035; ?><br><?php echo $email1035; ?></a>
																	</li>
																</li>
															</ul>
														</li>
