...
<div class="navbar">
			...
			<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-90deg-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			 ...
			 Back</a>
			<a href="flowchart_Tha_F.php">Financial Department</a>
...
<div>
	<br>
	<h1>Thailand Company Staff<br>Maintenance Department</h1>
	<nav class="nav">
							<ul style="text-align: center;">
								<li>
									<a href="#">Manager<br><?php echo $Name1015; ?><br><?php echo $email1015; ?></a>
										<ul>
											<li>
												<a href="#">Deputy manager<br><?php echo $Name1016; ?><br><?php echo $email1016; ?></a>
													<ul>
														<li>
															<a href="#">Employee<br><?php echo $Name1018; ?><br><?php echo $email1018; ?></a>
																<li>
																	<a href="#">Employee<br><?php echo $Name1019; ?><br><?php echo $email1033; ?></a>
																</li>
														</li>
													</ul>
														<li>
															<a href="#">Director<br><?php echo $Name1017; ?><br><?php echo $email1017; ?></a>
															<ul>
																<li>
																	<a href="#">Employee<br><?php echo $Name1020; ?><br><?php echo $email1020; ?></a>
																	<li>
																		<a href="#">Employee<br><?php echo $Name1021; ?><br><?php echo $email1021; ?></a>
																	</li>
																</li>
															</ul>
														</li>
