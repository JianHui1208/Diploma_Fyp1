...
<div class="navbar">
			...
			<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-90deg-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			 ...
			 Back</a>
			<a href="flowchart_Tai_F.php">Financial Department</a>
			<a href="flowchart_Tai_HR.php">Human Resources Department</a>
			<a href="flowchart_Tai_Ma.php">Marketing Department</a>
			<a href="flowchart_Tai_IT.php">Information and Technology Department</a>
			 <?php
...
<div>
	<br>
	<h1>Taiwan Company Staff<br>Maintenance Department</h1>
	<nav class="nav">
